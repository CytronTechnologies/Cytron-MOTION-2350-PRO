...
This example code will control DC motor by using USB Controller with USB Host Function in Motion 2350 Pro
...
void setup() {
  ...
  motorL.setSpeed(0);
  //motorR.setSpeed(0);  //remove comment if want to add another motor
...
void loop() {
  ...
  if (system_ready) {
    ...
    //motorR.setSpeed(right_speed); //remove comment if want to add another motor
